...
import com.polarbookshop.edgeservive.config.SecurityConfig;
...
class SecurityConfigTests {
    ...
    private ClientRegistration testClientRegistration() {
        return ClientRegistration.withRegistrationId("test").authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
                .clientId("test")
